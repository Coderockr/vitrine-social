...
class About extends React.Component {
  ...
  renderLastSection = () => (
    <div className={styles.itemSection}>
      ...
      <p>
        Pronto! Doando desta forma, além de poupar o seu tempo buscando entidades confiáveis,
        você ainda tem a certeza de que os recursos doados serão recebidos e utilizados de forma
        eficiente pelas entidades que mais os necessitam! Seja uma entidade grande e de renome ou
        aquela pequena entidade que você ainda não conhecia.
      </p>
    </div>
  );
        ...
        <Row>
          <Col span={20} offset={2} className={styles.lastSection}>
            ...
            <div className={styles.mainText}>
              ...
              Coderockr Jams, eventos internos da Coderockr realizados com o propósito de aprender
